...
public class ControllerGenerator {
    ...
    private static ClassName serviceClass = ClassName.get(servicePathStr, serviceName);


    public static void generator() throws IOException {


        TypeSpec typeSpec = TypeSpec.classBuilder(modelName + "Controller")
                ...
                .addAnnotation(AnnotationSpec.builder(org.springframework.web.bind.annotation.RequestMapping.class)
                        .addMember("value", "$S", Util.toLowerCaseFirstOne(modelName))
                        .build())
                .addAnnotation(AnnotationSpec.builder(io.swagger.annotations.Api.class)
                        .addMember("description", "$S", modelDescription + "模块")
                        .build())
                .addAnnotation(lombok.AllArgsConstructor.class)
                .addField(serviceClass, serviceImplFieldName, Modifier.PRIVATE, Modifier.FINAL)
        ...
        //生成一个Java文件
        JavaFile javaFile = JavaFile.builder(packagePathStr + ".controller", typeSpec)
                .build();
    ...
    public static MethodSpec getEditMethod() {
        ParameterSpec parameterSpec = ParameterSpec.builder(editFormNameClass, "form").addAnnotation(validAnnotation).addAnnotation(requestBodyAnnotation).build();
        MethodSpec methodSpec = MethodSpec.methodBuilder("edit")
                ...
                .addAnnotation(AnnotationSpec.builder(org.springframework.web.bind.annotation.PostMapping.class)
                        ...
                        .build())
                .addAnnotation(AnnotationSpec.builder(sysLogClass)
                        .addMember("value", "$S", "新增与编辑" + modelDescription)
                        .build())
                .addAnnotation(AnnotationSpec.builder(io.swagger.annotations.ApiOperation.class)
                        .addMember("value", "$S", "新增与编辑" + modelDescription)
                        .build())
                .addJavadoc("@param form " + modelDescription + "编辑信息\n" +
                        "@return R\n" +
                        "@description 新增与编辑" + modelDescription + "信息\n" +
                        "@auther: 邵锦杰\n")
                .addStatement("$T user = $T.getUser()", chemicalUserClass, securityUtilsClass)
                .addStatement("return this." + serviceImplFieldName + ".edit(form, user)")
                .build();
        return methodSpec;
    }
    ...
    public static MethodSpec getListPagingMethod() {
        ParameterSpec parameterSpec = ParameterSpec.builder(listPagingFormClass, "form").addAnnotation(validAnnotation).addAnnotation(requestBodyAnnotation).build();
        MethodSpec methodSpec = MethodSpec.methodBuilder("listPaging")
                ...
                .addAnnotation(AnnotationSpec.builder(org.springframework.web.bind.annotation.PostMapping.class)
                        ...
                        .build())
                .addAnnotation(AnnotationSpec.builder(sysLogClass)
                        .addMember("value", "$S", "分页获取" + modelDescription)
                        .build())
                .addAnnotation(AnnotationSpec.builder(io.swagger.annotations.ApiOperation.class)
                        .addMember("value", "$S", "分页获取" + modelDescription)
                        .build())
                .addJavadoc("@param form " + modelDescription + "分页查询信息\n" +
                        "@return R\n" +
                        "@description 分页获取" + modelDescription + "信息\n" +
                        "@auther: 邵锦杰\n")
                .addStatement("$T user = $T.getUser()", chemicalUserClass, securityUtilsClass)
                .addStatement("return this." + serviceImplFieldName + ".listPaging(form, user)")
                .build();
        return methodSpec;
    }
    ...
    public static MethodSpec getGetEditInfoMethod() {
        ParameterSpec parameterSpec = ParameterSpec.builder(Integer.class, "id")
                .addAnnotation(AnnotationSpec.builder(io.swagger.annotations.ApiParam.class)
                        ...
                        .addMember("value", "$S", modelDescription + "id")
                        .build())
        ...
        MethodSpec methodSpec = MethodSpec.methodBuilder("getEditInfo")
                ...
                .addAnnotation(AnnotationSpec.builder(org.springframework.web.bind.annotation.PostMapping.class)
                        ...
                        .build())
                .addAnnotation(AnnotationSpec.builder(sysLogClass)
                        .addMember("value", "$S", "获取" + modelDescription + "编辑信息")
                        .build())
                .addAnnotation(AnnotationSpec.builder(io.swagger.annotations.ApiOperation.class)
                        .addMember("value", "$S", "获取" + modelDescription + "编辑信息")
                        .build())
                .addJavadoc("@param id " + modelDescription + "id\n" +
                        "@return R\n" +
                        "@description 获取" + modelDescription + "编辑信息\n" +
                        "@auther: 邵锦杰\n")
                .addStatement("$T user = $T.getUser()", chemicalUserClass, securityUtilsClass)
                .addStatement("return this." + serviceImplFieldName + ".getEditInfo(id, user)")
                .build();
        return methodSpec;
    }
    ...
    public static MethodSpec getGetDetailMethod() {
        ...
        MethodSpec methodSpec = MethodSpec.methodBuilder("getDetail")
                ...
                .addAnnotation(AnnotationSpec.builder(org.springframework.web.bind.annotation.PostMapping.class)
                        ...
                        .build())
                .addAnnotation(AnnotationSpec.builder(sysLogClass)
                        .addMember("value", "$S", "获取" + modelDescription + "详细信息")
                        .build())
                .addAnnotation(AnnotationSpec.builder(io.swagger.annotations.ApiOperation.class)
                        .addMember("value", "$S", "获取" + modelDescription + "详细信息")
                        .build())
                .addJavadoc("@param id " + modelDescription + "id\n" +
                        "@return R\n" +
                        "@description 获取" + modelDescription + "详细信息\n" +
                        "@auther: 邵锦杰\n")
                .addStatement("$T user = $T.getUser()", chemicalUserClass, securityUtilsClass)
                .addStatement("return this." + serviceImplFieldName + ".getDetail(id, user)")
                .build();
        return methodSpec;
    }
    ...
    public static MethodSpec getDeleteMethod() {
        ...
        MethodSpec methodSpec = MethodSpec.methodBuilder("delete")
                ...
                .addParameter(parameterSpec)
                .addAnnotation(AnnotationSpec.builder(org.springframework.web.bind.annotation.PostMapping.class)
                        .addMember("value", "$S", "delete/{idList}")
                        .build())
                .addAnnotation(AnnotationSpec.builder(sysLogClass)
                        .addMember("value", "$S", modelDescription + "删除")
                        .build())
                .addAnnotation(AnnotationSpec.builder(io.swagger.annotations.ApiOperation.class)
                        .addMember("value", "$S", modelDescription + "删除")
                        .build())
                .addJavadoc("@param idList " + modelDescription + "主键列表\n" +
                        "@return R\n" +
                        "@description " + modelDescription + "删除\n" +
                        "@auther: 邵锦杰\n")
                .addStatement("$T user = $T.getUser()", chemicalUserClass, securityUtilsClass)
                .addStatement("return this." + serviceImplFieldName + ".delete(idList, user)")
                .build();
        return methodSpec;
    }
}
